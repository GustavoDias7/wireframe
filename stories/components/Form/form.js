function form({ fields = [] }) {
  ...
  fields.forEach((field) => {
    ...
    if (field.type === "file") {
      ...
      if (field.size !== "default") $field.classList.add(field.size);
      if (field?.placeholder) $field.placeholder = field.placeholder;
      else if (field?.label) $field.placeholder = field.label;
      ...
      switch (field.variant || "") {
        ...
        default:
          $f_label.innerText = field.label;
          if (field.size !== "default") $f_label.classList.add(field.size);
